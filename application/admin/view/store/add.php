                ...
                <div class="widget-body">
                    <fieldset>
                        <div class="widget-head am-cf">
                            <div class="widget-title am-fl">新增平台</div>
                        </div>
                        <div class="am-form-group">
                            <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require"> 平台名称 </label>
                        ...
                        <div class="am-form-group am-padding-top-sm">
                            <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require"> 平台账户名 </label>
                            <div class="am-u-sm-9 am-u-end">
                        ...
                        <div class="am-form-group">
                            <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require"> 平台账户密码 </label>
                            <div class="am-u-sm-9 am-u-end">
                                <input type="password" class="tpl-form-input" name="store[password]" value=""
                                       required>
                                <small>平台后台用户密码</small>
                            </div>
                        </div>
                        <div class="am-form-group">
