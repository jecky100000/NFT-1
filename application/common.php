 ...
 * @return array
 */
function arrayKeytoCamelCase($arr)
{
    $re = [];
    foreach ($arr as $k=>$v)
    {
 ...
 * @param string $type
 */
function log_write_sms($value, $type = 'sms')
{
 ...
 * @param string $type
 */
function log_write_pay($value, $type = 'pay')
{
    $msg = is_string($value) ? $value : var_export($value, true);
    Log::record($msg, $type);
}
 ...
 * @param string $type
 */
function log_write_order($value, $type = 'order')
{
    $msg = is_string($value) ? $value : var_export($value, true);
    Log::record($msg, $type);
}
 ...
 * @param string $type
 */
function log_write_task($value, $type = 'task')
{
    $msg = is_string($value) ? $value : var_export($value, true);
    Log::record($msg, $type);
}
...
function get_version()
{
    ...
    $file = dirname(WEB_PATH) . '/version.json';
    if (!file_exists($file)) {
